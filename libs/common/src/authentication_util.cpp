...
extern AuthenticationType convert_authentication_type_from_str(const std::string& str)
{
	...
	std::cerr << "Failed to convert a string to OSType" << std::endl;
	throw std::bad_cast();
}

std::string www_authentication_info::get_authorization(const std::string& method, const std::string& url)
{
...
std::string www_authentication_info::_get_response(const std::string& method, const std::string& url)
{
	std::string h1 = "";
	std::string h2 = "";
	std::string h3 = "";
...
www_authentication_info::www_authentication_info(const std::string& un, const std::string& pw, const std::string& auth_info)
{
	m_username = un;
	m_password = pw;
